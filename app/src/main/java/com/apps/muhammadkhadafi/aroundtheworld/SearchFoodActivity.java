...
public class SearchFoodActivity extends Activity {
    ...
    private Button buttonselectFood;
    ...
    private String passedPhotoPath = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonNext = (Button) findViewById(R.id.btn_nextpage);
        buttonPrev = (Button) findViewById(R.id.btn_prevpage);
        buttonselectFood = (Button) findViewById(R.id.btn_selectfood);
        resultPage = (TextView) findViewById(R.id.result_page);
        foodName = (TextView) findViewById(R.id.txt_foodnamesearch);
        ...
        foodNameString = b.getString("search");
        passedPhotoPath = b.getString("photopath");
        foodName.setText(foodNameString);

        foodID = new String[resultsPerPage];

        new FoodAsync().execute(foodNameString, "0", "start");

        buttonNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new FoodAsync().execute(foodNameString, currentPage + "", "next");
            }
        });
        buttonPrev.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new FoodAsync().execute(foodNameString, currentPage + "", "prev");
            }
        });
        buttonselectFood.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (selectedID.toString().equals("")) {
                    Toast.makeText(getApplicationContext(), "Select food first", Toast.LENGTH_LONG);
                }
                else {
                    Intent intent = new Intent(getApplicationContext(), MealAddActivity.class);
                    Bundle b = new Bundle();
                    b.putString("foodid", selectedID); //Your id
                    b.putString("photopath", passedPhotoPath);
...
//        createData();
        ...
        expandableFoodList.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
            ...
            public void onGroupExpand(int groupPosition) {
                ...
                selectedID = foodID[groupPosition];
...
//            String header = "&" + args + "&oauth_signature=" + URLEncoder.encode(signature, "UTF-8");
            ...
            try {
                ...
                if (foodResults.length() == 0) return "no results";
                ...
                for (int i = 0; i < loopNumber; i++) {
                    ...
                    foodID[i] = foodResults.getJSONObject(i).getJSONObject("fields").getString("item_id");
                }
...
//                    Log.d("response", food_array[i]);
        ...
        protected void onPostExecute(String[] result) {
            ...
            if (result[0] == "no results") {
                Group group = new Group("No results", "Please try another search term");
                group.children.add("");
